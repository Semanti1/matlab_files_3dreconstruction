...
%%
img1 = imread('/home/semanti/Downloads/dinoSparseRing/dinoSR0001.png');
img2 = imread('/home/semanti/Downloads/dinoSparseRing/dinoSR0002.png');
...
figure
plot(img2pts(2,:),img2pts(1,:), 'ro');
hold on
% figure
plot(affpts(2,:),affpts(1,:), 'bo');

%%
aff_ds=downsample(affpts',10);
img2_ds = downsample(img2pts',10);
dm=pdist2(aff_ds,img2_ds);
% figure
% plot(img2_ds(:,2),img2_ds(:,1), 'ro');
% hold on
% % figure
% plot(aff_ds(:,2),aff_ds(:,1), 'bo');
[v,i]=min(dm,[],2);
mtch2 = img2_ds(i,:);
mtch1 = downsample(img1pts',10);
figure
imshow(img1);
hold on;
plot(mtch1(:,2),mtch1(:,1),'rx');
figure
imshow(img2);
hold on;
plot(mtch2(:,2),mtch2(:,1),'gx');
x=[mtch1(:,1),mtch1(:,2)]';
y =[mtch2(:,1),mtch1(:,2)]';
%%
